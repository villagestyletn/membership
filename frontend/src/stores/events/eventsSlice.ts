...
export const deleteItemsByIds = createAsyncThunk(
  ...
  async (data: any, { rejectWithValue }) => {
    try {
      await axios.post('events/deleteByIds', { data });
    } catch (error) {
      if (!error.response) {
        throw error;
      }
...
export const deleteItem = createAsyncThunk('events/deleteEvents', async (id: string, { rejectWithValue }) => {
    try {
...
export const create = createAsyncThunk('events/createEvents', async (data: any, { rejectWithValue }) => {
    try {
...
export const update = createAsyncThunk('events/updateEvents', async (payload: any, { rejectWithValue }) => {
    try {
...
export const eventsSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(deleteItemsByIds.fulfilled, (state) => {
            state.loading = false;
            fulfilledNotify(state, 'Events has been deleted');
        });
